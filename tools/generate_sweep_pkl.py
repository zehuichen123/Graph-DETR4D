...
info_path = os.path.join(data_root,'mmdet3d_nuscenes_30f_infos_{}_tiny.pkl'.format(info_prefix))
...
def add_frame(sample_data, e2g_t, l2e_t, l2e_r_mat, e2g_r_mat):
    ...
    # NOTE new added
    # sweep_cam['calibrated_sensor_token'] = sample_data['calibrated_sensor_token']
    # sweep_cam['ego_pose_token'] = sample_data['ego_pose_token']
