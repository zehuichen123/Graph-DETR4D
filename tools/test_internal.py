...
def main():
    ...
    if rank == 0:
        ...
        # internal_evaluator = InternalEvaluator(cfg.data.val.ann_file, args.out)
        # internal_evaluator.evaluate_internal_data()

        # visualize_internal_data
        # internal_visualizer = InternalVisualizer(args.config, args.out)
        # internal_visualizer.visualize()
