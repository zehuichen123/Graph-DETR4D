...
distiller = dict(
    ...
    student_pretrained = 'data/pretrain_models/fcos3d_mobilev2_new.pth',
    init_student = False,
    loss_feat_distill=dict(type='vanilla', loss_weight=0.1),
    loss_reg_distill=dict(type='L1Loss', loss_weight=0.25),
...
student_cfg = 'projects/configs/detr4d/detr4d_m2_deform_pe_testaug_320_fullset_ceph.py'
