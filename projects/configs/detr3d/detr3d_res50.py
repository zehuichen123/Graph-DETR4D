...
train_pipeline = [
    ...
    # dict(type='LoadMultiViewImageFromMultiSweepsFiles', sweeps_num=1, to_float32=True, file_client_args=file_client_args, pad_empty_sweeps=True, test_mode=False, sweep_range=[3,10]),
