...
distiller = dict(
    ...
    teacher_pretrained = '/mnt/cache/chenzehui/code/chenzheng/detr4d/work_dirs/detr4d_res50_deform_pe_testaug_2subset_12e/epoch_12.pth',
    init_student = False,
    distill_cfg = [
        # dict(student_module = 'img_neck.fpn_convs.4.conv',
        #                  teacher_module = 'img_neck.fpn_convs.4.conv',
        #                  output_hook = True,
        ...
        #                         ]
        #                 ),
        #             dict(student_module = 'img_neck.fpn_convs.3.conv',
...
data = dict(
    ...
    train=dict(
        ...
        load_interval=2,
        box_type_3d='LiDAR'),
    val=dict(type=dataset_type, pipeline=test_pipeline, data_root=data_root,ann_file=data_root + 'new_mmdet3d_nuscenes_30f_infos_val.pkl', classes=class_names, modality=input_modality),
    test=dict(type=dataset_type, pipeline=test_pipeline, data_root=data_root,ann_file=data_root + 'new_mmdet3d_nuscenes_30f_infos_val.pkl', classes=class_names, modality=input_modality))
#-------------------------------

student_cfg = 'projects/configs/detr4d/detr4d_res50_deform_pe_testaug_2subset_12e.py'
teacher_cfg = 'projects/configs/detr4d/detr4d_res50_deform_pe_testaug_2subset_12e.py'
optimizer = dict(
    type='AdamW',
    lr=2e-4,
    paramwise_cfg=dict(
